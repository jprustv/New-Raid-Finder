...
function rf.main(_, addon)
	...
	if (addon == addonInfo.toc.Identifier) then		
		...
		rf.updateAchievementsTable()
		rf.maxNumberOfAchievements = table.getn(rf.achtable)
...
function rf.open()
	...
	-- HUEHUE
	if rf.maxNumberOfAchievements < 17 then
		rf.updateAchievementsTable()
		rf.maxNumberOfAchievements = table.getn(rf.achtable)
	end
	...
	local manual = { { 	parent = nil,
					...
					{ 	parent = nil,
						...
						content = {	{	type = 'header',
									...
									{	type = 'text',
										text = 'Tier 1 Experience - Shows the number of bosses a player have killed in Tier 1 Raids.',
									},
									{	type = 'header',
										text = 'T2 - ',
									},
									{	type = 'text',
										text = 'Tier 2 Experience - Shows the number of bosss a player have killed in Tier 2 Raids.',
									},
									{	type = 'header',
										text = 'RC - ',
									},
									{	type = 'text',
										text = 'Raids Completed - Shows the number of raids a player have completed. (You complete a raid by killing all bosses on it)',
									},
									{	type = 'header',
										text = 'CQ - ',
									},
									{	type = 'text',
										text = 'Conquerors - Shows the number of raids a player have achieved [Conqueror]. (You achieve a Conqueror by doing all achievements needed for the [Conqueror] Achievement.)',
									},
								},
					},
				}
